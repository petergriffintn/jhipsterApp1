...
describe('Service Tests', () => {
    ...
    describe('UniversiteMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UniversiteMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/universites';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UniversiteMySuffix', () => {
