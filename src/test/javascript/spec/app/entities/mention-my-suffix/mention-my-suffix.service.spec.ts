...
describe('Service Tests', () => {
    ...
    describe('MentionMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MentionMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/mentions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MentionMySuffix', () => {
