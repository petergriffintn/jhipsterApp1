...
describe('Service Tests', () => {
    ...
    describe('ProgrammeMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProgrammeMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/programmes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProgrammeMySuffix', () => {
