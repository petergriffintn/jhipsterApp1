...
describe('Service Tests', () => {
    ...
    describe('ParcoursMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParcoursMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/parcours';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ParcoursMySuffix', () => {
