...
public class MentionResourceIntTest {
    ...
    public void createMention() throws Exception {
        ...
        assertThat(testMention.getLibelleFr()).isEqualTo(DEFAULT_LIBELLE_FR);
        assertThat(testMention.getLibelleAr()).isEqualTo(DEFAULT_LIBELLE_AR);
    }
    ...
    public void updateMention() throws Exception {
        ...
        // Update the mention
        Mention updatedMention = mentionRepository.findOne(mention.getId());
        ...
        Mention testMention = mentionList.get(mentionList.size() - 1);
        assertThat(testMention.getLibelleFr()).isEqualTo(UPDATED_LIBELLE_FR);
        assertThat(testMention.getLibelleAr()).isEqualTo(UPDATED_LIBELLE_AR);
    }
    ...
    public void updateNonExistingMention() throws Exception {
        ...
        // Validate the Mention in the database
        List<Mention> mentionList = mentionRepository.findAll();
        assertThat(mentionList).hasSize(databaseSizeBeforeUpdate + 1);
    }
